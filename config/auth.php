...
return [
    ...
    */
    ...
    | A continuación, puede definir cada guard de autenticación para su aplicación.
    | Por supuesto, se ha definido una buena configuración predeterminada para usted
